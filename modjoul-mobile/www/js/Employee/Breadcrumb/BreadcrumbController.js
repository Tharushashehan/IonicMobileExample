...
(function () {
    ...
    angular.module('modjoul-mobile.controllers')
        .controller('BreadcrumbCtrl', ['$scope', 'MapConstants', 'MapMessages', '$cordovaGeolocation', '$compile', '$timeout',
            '$ionicPopup', 'ionicDatePicker', 'BreadcrumbService', 'SupervisorOutOfBoundsService',
            'STRINGS', '$localStorage', '$cordovaDialogs', '$ionicLoading', '$log',
            function ($scope, MapConstants, MapMessages, $cordovaGeolocation, $compile, $timeout,
                      $ionicPopup, ionicDatePicker, BreadcrumbService, SupervisorOutOfBoundsService, STRINGS, $localStorage,
                ...
                console.log("showDrivingHistory", $scope.showDrivingHistory);
                var polylineOptions = {
                    strokeColor: '#C83939',
                    strokeOpacity: 0,
                    strokeWeight: 4,
                                    ...
                                    switch (locationValue.activity) {
                                        ...
                                        case STRINGS.BREADCRUMB_ACTIVITY_LIST.DRIVE.HARD_ACCELERATION:
                                            ...
                                            marker.addListener('click', function () {
                                                ...
                                                BreadcrumbService.getBreadcrumbTrailEventDetails(orgId, userId, locationValue.eventId).then(function (result) {
                ...
                $scope.filterBreadcrumb = function () {
                    $ionicPopup.show({
                        templateUrl: "templates/breadcrumbmapfilter.html",
                        scope: $scope,
                        cssClass: 'map-filter',
                        buttons: [
                            {
