...
export const STRINGS = {
            ...
            ORG_CONFIG: {
                ACTUAL : {
                    ...
                    lying: "lying",
                    idleLying: "IdleTimeLaying",
                    timeToExitVehicle: "timeToExitVehicle",

                    driveTime: "driveTime",
                    driving: "driving",

                    workFromHeights:"workFromHeights",
                ...
                PRETTY : {
                    ...
                    idleDriving: "Stuck In Traffic",
                    lying: "Lying",
                    idleLying: "Lying",
                    timeToExitVehicle: "Time To Exit Vehicle",

                    workFromHeights: "Work From Heights",
                    ...
                    hardCorner: "Hard Cornering",
                    hardBrake: "Hard Braking",
                    swerve: "Hard Swerving",
                    overSpeedLimit:"Over Speed Limit",

                    nearMissEvents: "Trips & Falls",
                    falling: "Falls",
                    tripping: "Trips"
                }
            ...
            //Newly added after 08/01/2019

            CARDVIEW_MODEL_ARRAY : {"walking" : ["TotalWalkingSteps","TotalWalkingTime"],
            "bending":["TotalBendingCount","TotalBendingTime"],
            "twisting":["TotalTwistingCount","TotalTwistingTime"],
            "stationary_work":["StationaryWorkTimePercentage","StationaryWorkTime"],
            "indoor_driving":["IndoorDrivingSafety","IndoorDrivingTime"],
            "driving":["DrivingDistance","DrivingTime"],
            "sitting_standing":["SittingStandingTimePercentage","SittingStandingTime"],
            "laying":["LayingTimePercentage","LayingTime"]
            },

            TERM_REGULATION_ARRAY:[["walking","Walk value"],
                ["bending","Bend value"],
                ["twisting","Twist value"],
                ["stationary_work","Stationery work value"],
                ["indoor_driving", "Indoor driving value"],
                ["driving", "Driving value"],
                ["sitting_standing", "Sitting standing value"],
                ["laying", "Laying value"],
                                ]
        }